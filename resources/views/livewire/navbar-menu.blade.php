    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="{{ asset('images/logo.jpg') }}" class="h-10" alt="Accel 365 logo" />
                {{-- <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Accel 365</span> --}}
            </a>
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
                <ul
                    ...
                    <li>
                        <a href="/update"
                            class="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500 dark:bg-blue-600 md:dark:bg-transparent"
                            aria-current="page">Update Data</a>
                    </li>
                    @if (auth()->user()->role > 5)
                        <li>
                            ...
                            <div id="dropdownNavbar"
                                ...
                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-400"
                                    ...
                                    <li>
                                        <a href="/registration"
                                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Registration</a>
                                    </li>
                                    <li>
                                        <a href="/update"
